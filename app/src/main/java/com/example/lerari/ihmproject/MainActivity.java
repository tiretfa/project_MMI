...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Recette> generateRecette(){
        ...
        etapes.add(new Etape("couper les pommes de terre ", R.drawable.img1, 5000)) ;
        etapes.add(new Etape("couper les carottes", R.drawable.img2, 2000));
        etapes.add( new Etape( "couper les courgettes", R.drawable.img3, 2000));
        etapes.add( new Etape( "mettre le tout dans une casserole", R.drawable.img4, 2000));
        etapes.add(new Etape("couper les pommes de terre ", R.drawable.img5, 2000)) ;
        etapes.add(new Etape( "couper les carottes", R.drawable.img6, 2000));

        ingredients.add(new Ingredient("piment rouge", R.drawable.ing1));
        ingredients.add(new Ingredient("courgette", R.drawable.ing2));
        ingredients.add(new Ingredient("courgette", R.drawable.ing3));
